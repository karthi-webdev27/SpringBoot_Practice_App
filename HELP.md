...
* The original package name 'karthiCodes.spring.com.Basic CRUD operations' is invalid and this project uses 'karthiCodes.spring.com.Basic.CRUD.operations' instead.
